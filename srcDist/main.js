...
import { Tilemap, HitBox } from "./tilemapParser.js";
import { Player } from "./player.js";
import { Keyboard } from "./keyboardHandler.js";
import { StatsHandler } from "./statsHandler.js";
import { ResourcesManager } from "./resources.js";
document.querySelector('#app').outerHTML = "<div id='statspanel'></div>";
...
let resourceManager = new ResourcesManager(tilemap.resourceLayers, resourceOptions, itemsJSON, player.inventory, app, 1000, (msg) => player.showMessage(msg));
...
app.ticker.add(() => { if (!kbd.isWasdPressed()) {
    player.gotoAndStop(0);
    player.isMoving = false;
} });
app.ticker.add(() => { if (player.isMoving) {
    handleVisualChunks();
} });
